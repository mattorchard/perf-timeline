...
export const getBestSize = (containerSize: Size, mediaSize: Size): Size => {
	const hScale = containerSize.height / mediaSize.height;
	const wScale = containerSize.width / mediaSize.width;
